...
function Prepare() {
  return (
    <Box>
      ...
      <Divider />
      <Typography pt={4} pb={4} sx={{fontSize: '15px', color: 'textColor.main', lineHeight: 2}}>
      ...
      <Typography   pb={2} sx={{fontSize: '15px', color: 'textColor.main', lineHeight: 2}}>
      ...
      <Typography   pb={4} sx={{fontSize: '15px', color: 'textColor.main', lineHeight: 2}}>
